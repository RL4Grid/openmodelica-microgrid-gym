...
class Inverter(Component):
    def __init__(self, u=None, i=None, v=None, i_nom=20, i_lim=30, v_lim=600, v_DC=1000, i_ref=(0, 0, 0), **kwargs):
        ...
        self.v_DC = v_DC
        self.i_ref = i_ref
        # TODO add energy values to config or defaults, instanciate 3 integrals, one for each phase, its just about the I
        self.limit_load_integrals = [LimitLoadIntegral() for _ in range(3)]
