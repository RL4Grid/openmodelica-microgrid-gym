...
m.Equation(J*w3*w3.dt()==((-P3)+(droop_linear[2]*(w3-nomFreq)))/(J*w2))
...
#Set global options
m.options.IMODE = 4 #steady state optimization

m.time = np.linspace(0,1.5,500) # time points
