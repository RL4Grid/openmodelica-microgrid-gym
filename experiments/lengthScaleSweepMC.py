...
save_folder = os.path.join(current_directory, r'len_sweep_cc')
...
lengthscale_vec_kP = np.linspace(0.01, 0.35, 5)
lengthscale_vec_kI = np.linspace(50, 400, 6)
    ...
    for kk in range(len(lengthscale_vec_kP)):
        ...
        for ii in range(len(lengthscale_vec_kI)):
            ...
            # For 2D example, choose Kp and Ki as mutable parameters
                ...
                mutable_params = dict(currentP=MutableFloat(0.05), currentI=MutableFloat(20))
            ...
            if include_simulate:
                ...
                env = gym.make('openmodelica_microgrid_gym:ModelicaEnv_test-v1',
                               ...
                               model_path='../fmu/grid.paper_ALT.fmu',
